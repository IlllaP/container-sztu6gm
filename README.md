...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-sztu6gm.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-sztu6gm.containers.anotherwebservice.com/
...
```
git clone git@github.com:IlllaP/container-sztu6gm.git
cd container-sztu6gm
```
...
```
docker attach container-sztu6gm
```
